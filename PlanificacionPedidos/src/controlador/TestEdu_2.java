...
public class TestEdu_2 {
	...
	private void iniciar() {
		 ...
		 * pedidos) System.out.println(p.getId() + "  " + p.getDescripcion());
		 * 
		 * 
		 * pedidos=null;
		 * 
		 * Empleado e = sistema.buscarEmpleado(136378); pedidos =
		 * sistema.reporteCantidadDePedidosResueltosPorEmpleado(e);
		 * 
