 ...
 */
public class TipoPedidoModificar extends javax.swing.JPanel {
	/**
	 * 
	 */
	...
	private TipoPedidoModificar instancia;
	...
	public TipoPedidoModificar(JTabbedPane p) {
		super();
		panel = p;
		instancia = this;
		initGUI();
		...
		try {
			...
			}
			{
				...
				jButtonConfirmar.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent evt) {
						Tipo.setTiempo(Integer.parseInt(jTextFieldFactor.getText()));
						Sistema.getInstancia().modificarTipoPedido(Tipo);
