 ...
 */
public class ComplejidadPedidoModificar extends javax.swing.JPanel {
	/**
	 * 
	 */
	...
	private ComplejidadPedidoModificar instancia;
	...
	public ComplejidadPedidoModificar(JTabbedPane p) {
		super();
		panel = p;
		instancia = this;
		initGUI();
