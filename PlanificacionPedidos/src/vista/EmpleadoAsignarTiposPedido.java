 ...
 */
public class EmpleadoAsignarTiposPedido extends javax.swing.JPanel {
	/**
	 * 
	 */
	...
	private JLabel jLabelTiposEmpleado;
	private JTable jTable1;
	private JButton jButtonConfirmar;
	private JTabbedPane panel;
	private JButton jButtonSalir;
	private JScrollPane jScrollPane1;
	private EmpleadoAsignarTiposPedido instancia;
	...
	public EmpleadoAsignarTiposPedido(JTabbedPane p) {
		super();
		panel = p;
		instancia = this;
		initGUI();
	...
	private void initGUI() {
		try {
			...
			{
				jLabelTiposEmpleado = new JLabel();
				this.add(jLabelTiposEmpleado);
				jLabelTiposEmpleado.setText("Tipos permitidos:");
				jLabelTiposEmpleado.setBounds(293, 88, 159, 16);
				jLabelTiposEmpleado.setFont(new java.awt.Font("Segoe UI", 1, 12));
			}
			{
				jLabelTipos = new JLabel();
				this.add(jLabelTipos);
				jLabelTipos.setText("Tipos restantes:");
				jLabelTipos.setBounds(487, 88, 159, 16);
				jLabelTipos.setFont(new java.awt.Font("Segoe UI", 1, 12));
			}
			{
